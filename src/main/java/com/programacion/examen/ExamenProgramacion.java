...
public class ExamenProgramacion {
    public static void main(String[] args) {
        ...
        final char[] T2 = {ORDENADOR,ORDENADOR,USUARIO,USUARIO,USUARIO,ORDENADOR,USUARIO,ORDENADOR,USUARIO,ORDENADOR};
        ...
        final char[] T4 = {ORDENADOR,ORDENADOR,USUARIO,ORDENADOR,USUARIO,ORDENADOR,USUARIO,ORDENADOR,USUARIO,ORDENADOR};
